          ...
          <div className="container mx-auto px-4 max-w-4xl">
            <div className="prose prose-lg mx-auto">
              <p className="text-lg leading-relaxed mb-6">
                Welcome to Luxe Living, where sophistication meets everyday elegance. We curate a 
              ...
              <p className="leading-relaxed mb-6">
                ...
                Luxe Living has become synonymous with quality, elegance, and timeless design. Each 
