...
import { Minus, Plus, ShoppingCart, X, Star, ShieldCheck, Truck, Banknote, Package, ChevronRight, RotateCcw, CreditCard, Smartphone, Landmark } from "lucide-react";
                    ...
                    <Card className="bg-primary/5 border-primary/20">
                      <CardContent className="p-6">
                        ...
                        <p className="text-sm leading-relaxed">
                          We stand behind the quality of our products. Every item is carefully inspected before dispatch.
                          If you're not completely satisfied with your purchase, contact our customer support team within 7
                          days and we'll make it right.
                        </p>
                      </CardContent>
                    </Card>
                  </div>
